...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='elder',
            name='cared_by',
            field=models.ManyToManyField(to='member.CareGiver', verbose_name=b'Dirawat oleh', through='member.CareGiving'),
        ),
        migrations.AlterField(
            model_name='elder',
            name='code',
        ...
        migrations.AlterField(
            model_name='partner',
            name='type',
            field=models.CharField(default=b'pj', max_length=2, verbose_name=b'Golongan Institusi', choices=[(b'rs', b'Rumah Sakit'), (b'pj', b'Panti Jompo'), (b'km', b'Kelompok Minat')]),
        ),
    ]
