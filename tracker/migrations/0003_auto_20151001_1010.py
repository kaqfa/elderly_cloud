...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='tracker',
            name='condition',
            field=models.SmallIntegerField(default=3, verbose_name=b'Kondisi', choices=[(1, b'tidak baik'), (2, b'biasa'), (3, b'baik')]),
        ),
        migrations.AlterField(
            model_name='tracker',
            name='elder',
        ...
        migrations.AlterField(
            model_name='tracker',
            name='type',
            field=models.CharField(default=b'cd', max_length=2, verbose_name=b'Jenis Penelusuran', choices=[(b'cd', b'daily condition'), (b'hr', b'heart rate'), (b'bg', b'blood glucose')]),
        ),
        migrations.AlterField(
            model_name='tracker',
            name='value',
