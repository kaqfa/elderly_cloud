    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level',
                 models.CharField(max_length=1, choices=[(b'1', b'info'), (b'2', b'warning'), (b'3', b'emergency')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=45)),
                ('content', models.TextField()),
                ('level', models.CharField(default=b'1', max_length=1,
        ...
        migrations.AddField(
            ...
            name='responded',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, through='notification.ResponseNotification',
                                         blank=True),
        ),
        migrations.AddField(
            model_name='notification',
