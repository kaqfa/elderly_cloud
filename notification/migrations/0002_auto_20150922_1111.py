...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='notification',
            name='recurring',
            field=models.CharField(max_length=1, choices=[('1', 'sekali'), ('2', 'harian'), ('3', 'mingguan'), ('4', 'bulanan'), ('5', 'weekday'), ('6', 'weekend')]),
        ),
        migrations.AlterField(
            model_name='notification',
            name='status',
        ...
        migrations.AlterField(
            ...
            name='level',
            field=models.CharField(default='1', max_length=1, choices=[('1', 'info'), ('2', 'warning'), ('3', 'emergency')]),
        ),
    ]
