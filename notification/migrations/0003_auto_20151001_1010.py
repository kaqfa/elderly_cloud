...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='notification',
            name='level',
            field=models.CharField(max_length=1, verbose_name=b'Tingkat Kepentingan',
        ...
        migrations.AlterField(
            model_name='notification',
            name='recurring',
            field=models.CharField(max_length=1, verbose_name=b'Diulang Tiap',
        ...
        migrations.AlterField(
            model_name='notification',
            name='responded',
            field=models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name=b'Direspon oleh',
                                         through='notification.ResponseNotification', blank=True),
        ),
        migrations.AlterField(
            model_name='notification',
            name='sender',
        ...
        migrations.AlterField(
            model_name='notificationtemplate',
            name='level',
            field=models.CharField(default=b'1', max_length=1, verbose_name=b'Tingkat Kepentingan',
                                   choices=[(b'1', b'info'), (b'2', b'warning'), (b'3', b'emergency')]),
        ),
        migrations.AlterField(
            model_name='notificationtemplate',
